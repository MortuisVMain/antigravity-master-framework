...
| :-: | :--- | :--- | :--- | :--- |
| **01** | **Universal Master-Cycle (v2.6)** | Universal Entry | 5-phase reaction loop: Awakening ➔ Skill-Hunting ➔ Critic Triad ➔ Surgical Execution ➔ Compound. | [`01_UNIVERSAL_MASTER_CYCLE.md`](./01_UNIVERSAL_MASTER_CYCLE.md) |
| **02** | **5-Step Deep Reasoning Loop** | Planning & Architecture | First principles, alternative trade-offs, pre-mortem, Mermaid state machines, verifiable action plan. | [`02_DEEP_REASONING_LOOP.md`](./02_DEEP_REASONING_LOOP.md) |
| **03** | **7-Step Feature Pipeline** | Feature Implementation | Strict pipeline: Plan ➔ Test (RED) ➔ Implement (GREEN) ➔ Review ➔ Verify ➔ Remember ➔ Benchmark. | [`03_SEVEN_STEP_PIPELINE.md`](./03_SEVEN_STEP_PIPELINE.md) |
| **04** | **TDD RED-GREEN-REFACTOR** | Quality Assurance | Zero production code written without a failing test first. Test isolation, no fake mocks. | [`04_TDD_DISCIPLINE.md`](./04_TDD_DISCIPLINE.md) |
